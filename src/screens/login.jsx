    ...
    <div className='main-div'>
        <div className="logreg-main">
          ...
          <div className='credentials-div'>
            ...
            <div>
              <p>E-mail</p>
              <input type='email' className='text-black text-base px-2' name="name" value={credentials.name} onChange={change} />
            </div>
            <div>
              <p>Password</p>
              <input type='password' className='text-black text-base px-2' name="password" value={credentials.password} onChange={change} />
            </div>
            <div>
